...
export function validateSettings(
	...
	return {
		...
		invertRoll: booleanSetting(source.invertRoll, defaults.invertRoll),
		...
		trailLength: numberSetting(source.trailLength, defaults.trailLength, 0.5, 12),
		trailBrightness: numberSetting(source.trailBrightness, defaults.trailBrightness, 0.15, 2),
